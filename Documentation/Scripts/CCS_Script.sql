...
CREATE TABLE [dbo].[ChallengeLanguage](
 ...
 CONSTRAINT [PK_ChallengeLanguage] PRIMARY KEY CLUSTERED 
(
	[challenge_language_id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [dbo].[CodeSubmission](
 ...
 CONSTRAINT [PK_CodeSubmisssion] PRIMARY KEY CLUSTERED 
(
	[code_submission_id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
CREATE TABLE [dbo].[TestCaseParameter](
 ...
 CONSTRAINT [PK_TestCaseParameter] PRIMARY KEY CLUSTERED 
(
	[test_case_parameter_id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[CodeSubmission]  WITH NOCHECK ADD  CONSTRAINT [CodeSubmisssion_Challenge_FK] FOREIGN KEY([challenge_id])
REFERENCES [dbo].[Challenge] ([challenge_id])
GO
...
GO
ALTER TABLE [dbo].[Parameter] ADD  DEFAULT ((1)) FOR [required]
GO
